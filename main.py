...
def extend_cfg(cfg):
    ...
    cfg.ANALYSIS.FREQUENCY.PREDICTIVITY.HARD_GATE_THRESHOLD = 0.0
    cfg.ANALYSIS.FREQUENCY.PREDICTIVITY.THRESHOLD_SWEEP = [
    ...
    cfg.ANALYSIS.FREQUENCY.PREDICTIVITY.CONFIDENCE_Z = 1.0
    cfg.ANALYSIS.FREQUENCY.PREDICTIVITY.RESIDUAL_ALPHA = 0.2
    cfg.ANALYSIS.FREQUENCY.PREDICTIVITY.RESIDUAL_ALPHA_SWEEP = [
        0.05, 0.1, 0.2, 0.3, 0.5
    ]
    cfg.ANALYSIS.FREQUENCY.PREDICTIVITY.PAIRED_BOOTSTRAP_SAMPLES = 2000
    cfg.ANALYSIS.FREQUENCY.PREDICTIVITY.COORDINATE_ASCENT_MAX_PASSES = 3
    cfg.ANALYSIS.FREQUENCY.PREDICTIVITY.SAVE_SAMPLE_PREDICTIONS = True
    cfg.ANALYSIS.FREQUENCY.PREDICTIVITY.SAVE_LOGITS = False
