...
def extend_cfg(cfg):
    ...
    # Independent third modality.  This branch encodes Fourier magnitude
    # descriptors directly instead of passing frequency-filtered images back
    # through CLIP's image tower.  Its projection head is trained once on the
    # base session and frozen for all incremental sessions.
    cfg.TRAINER.BiMC.FREQUENCY_MODALITY = CN()
    cfg.TRAINER.BiMC.FREQUENCY_MODALITY.ENABLED = False
    cfg.TRAINER.BiMC.FREQUENCY_MODALITY.GRID_SIZE = 16
    cfg.TRAINER.BiMC.FREQUENCY_MODALITY.RADIAL_BINS = 16
    cfg.TRAINER.BiMC.FREQUENCY_MODALITY.FFT_BATCH_SIZE = 16
    cfg.TRAINER.BiMC.FREQUENCY_MODALITY.FFT_DEVICE = "auto"
    cfg.TRAINER.BiMC.FREQUENCY_MODALITY.HIDDEN_DIM = 512
    cfg.TRAINER.BiMC.FREQUENCY_MODALITY.DROPOUT = 0.1
    cfg.TRAINER.BiMC.FREQUENCY_MODALITY.TRAIN_STEPS = 400
    cfg.TRAINER.BiMC.FREQUENCY_MODALITY.BATCH_SIZE = 256
    cfg.TRAINER.BiMC.FREQUENCY_MODALITY.LR = 1e-3
    cfg.TRAINER.BiMC.FREQUENCY_MODALITY.WEIGHT_DECAY = 1e-4
    cfg.TRAINER.BiMC.FREQUENCY_MODALITY.LOGIT_SCALE = 16.0
    cfg.TRAINER.BiMC.FREQUENCY_MODALITY.CLASSIFICATION_WEIGHT = 1.0
    cfg.TRAINER.BiMC.FREQUENCY_MODALITY.IMAGE_ALIGNMENT_WEIGHT = 0.5
    cfg.TRAINER.BiMC.FREQUENCY_MODALITY.LOG_INTERVAL = 100
    cfg.TRAINER.BiMC.FREQUENCY_MODALITY.TEMPERATURE = 1.0
    cfg.TRAINER.BiMC.FREQUENCY_MODALITY.FUSION_WEIGHT = 0.2
    cfg.TRAINER.BiMC.FREQUENCY_MODALITY.RELIABILITY_ALPHA = True
    cfg.TRAINER.BiMC.FREQUENCY_MODALITY.MIN_FUSION_WEIGHT = 0.0
    cfg.TRAINER.BiMC.FREQUENCY_MODALITY.UNCERTAINTY_SCALE = 2.0
    cfg.TRAINER.BiMC.FREQUENCY_MODALITY.SHOT_TAU = 5.0
    cfg.TRAINER.BiMC.FREQUENCY_MODALITY.NOVEL_CALIBRATION = False
